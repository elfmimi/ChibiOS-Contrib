 ...
 */
/**
 * @brief   UART0 / UART 1 driver enable switch.
 ...
 */
#if !defined(NUC123_SERIAL_UART0_PRIORITY) || defined(__DOXYGEN__)
#define NUC123_SERIAL_UART0_PRIORITY        3
#endif

#if !defined(NUC123_SERIAL_UART1_PRIORITY) || defined(__DOXYGEN__)
#define NUC123_SERIAL_UART1_PRIORITY        3
#endif
