 ...
 */
#if !defined(NUC123_USB_USE_USB0) || defined(__DOXYGEN__)
#define NUC123_USB_USE_USB0                  FALSE
#endif

/**
 * @brief   USB interrupt priority level setting.
 */
#if !defined(NUC123_USB_USB0_IRQ_PRIORITY) || defined(__DOXYGEN__)
#define NUC123_USB_USB0_IRQ_PRIORITY        2
#endif
