 ...
 * @{
 */
#if defined(NUC125SC2AE) || defined(NUC121SC2AE) || \
    defined(NUC125LC2AE) || defined(NUC121LC2AE) || \
    defined(NUC125ZC2AE) || defined(NUC121ZC2AE) || \
    defined(__DOXYGEN__)
#if defined(NUC125SC2AE)
#define PLATFORM_NAME           "NUC125SC2AE NUC125 Cortex M0 USB Micro"
#elif defined(NUC125LC2AE)
#define PLATFORM_NAME           "NUC125LC2AE NUC125 Cortex M0 USB Micro"
#elif defined(NUC125ZC2AE)
#define PLATFORM_NAME           "NUC125ZC2AE NUC125 Cortex M0 USB Micro"
#elif defined(NUC121SC2AE)
#define PLATFORM_NAME           "NUC121SC2AE NUC121 Cortex M0 USB Micro"
#elif defined(NUC121LC2AE)
#define PLATFORM_NAME           "NUC121LC2AE NUC121 Cortex M0 USB Micro"
#elif defined(NUC121ZC2AE)
#define PLATFORM_NAME           "NUC121ZC2AE NUC121 Cortex M0 USB Micro"
#endif
#define NUC125xxxAE
#undef NUC123xxxANx
#undef NUC123xxxAEx
#define NUC123_FLASH_SIZE 0x8000
#else
#error "NUC125 or NUC121 device unsupported or not specified"
#endif
 ...
 * @{
 */
#define NUC125_HCLKSRC_HSE     (0 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is HSE.      */
#define NUC125_HCLKSRC_LSE     (1 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is LSE.      */
#define NUC125_HCLKSRC_PLL     (2 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is PLL.      */
#define NUC125_HCLKSRC_LSI     (3 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is LSI.      */
#define NUC125_HCLKSRC_HSI     (4 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is HSI.      */
#define NUC125_HCLKSRC_PLL_2   (5 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is PLL/2.    */
#define NUC125_HCLKSRC_HSI_2   (7 << CLK_CLKSEL0_HCLK_S_Pos) /**< HCLK source is HSI/2.    */
/** @} */
...
#define NUC123_HSE_ENABLED                   FALSE
#endif
...
#define NUC123_HCLK 50000000UL
// #define NUC123_HCLK 48000000UL
#else
#define NUC123_HCLK __HIRC/2
#endif
#endif
...
#define NUC123_CONFIG_DATAFLASH_SIZE 2048
#endif
...
#if NUC123_PLL_ENABLED
#define NUC123_PLLCLK 100000000
// #define NUC123_PLLCLK 96000000UL
#else
#define NUC123_PLLCLK 48000000UL
#endif
...
// NUC125
#define NUC123_CONFIG0_DATAFLASH (NUC123_CONFIG0_DFEN_Msk)
#define NUC123_DFBADDR ((NUC123_FLASH_SIZE - NUC123_CONFIG_DATAFLASH_SIZE) & ~(0x1FFUL))
...
/* Various helpers */
#include "NUC125.h"
#include "nuc125_isr.h"
#include "nuc125_registry.h"
#include "nvic.h"
