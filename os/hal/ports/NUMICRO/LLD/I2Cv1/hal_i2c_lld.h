...
#define NUMICRO_I2C_USE_I2C0 TRUE
#endif
#if NUC123_HAS_I2C0
...
#define NUMICRO_I2C0_IRQ_VECTOR NUC123_I2C1_GLOBAL_HANDLER
#define NUMICRO_I2C1_IRQ_VECTOR NUC123_I2C2_GLOBAL_HANDLER
// #define NUMICRO_I2C0_IRQ_VECTOR I2C0_IRQHandler
// #define NUMICRO_I2C1_IRQ_VECTOR I2C1_IRQHandler
// #define OSAL_IRQ_HANDLER(x) void x(void)
// #define OSAL_IRQ_PROLOGUE()
// #define OSAL_IRQ_EPILOGUE()

// #define nvicEnableVector(x,y) do { /* NVIC_SetPriority(x,y); */ NVIC_EnableIRQ(x); } while(0)
// #define nvicDisableVector(x) NVIC_DisableIRQ(x)

// #if __NUC123__
// #define NUC123_HCLK 72000000
// #define I2C_PCLK NUC123_HCLK
...
#define NUMICRO_I2C_I2C0_PRIORITY        0
#endif
...
#define NUMICRO_I2C_I2C1_PRIORITY        3
#endif
